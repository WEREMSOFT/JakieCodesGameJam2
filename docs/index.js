...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/DinoSprites - doux.png",
      "start": 0,
      "end": 1899
    }, {
      "filename": "/assets/monochrome_32x32.png",
      "start": 1899,
      "end": 8152
    } ],
    "remote_package_size": 8152
  });
})();

// end include: /tmp/tmpb3xo9v0r.js
// include: /tmp/tmpsbmeaawn.js
...
// end include: /tmp/tmpsbmeaawn.js
// include: /tmp/tmpmfdho1gm.js
...
// end include: /tmp/tmpmfdho1gm.js
...
if (!ENVIRONMENT_IS_PTHREAD) {
  if (Module["wasmMemory"]) {
    ...
    assert(INITIAL_MEMORY >= 1024e3, "INITIAL_MEMORY should be larger than STACK_SIZE, was " + INITIAL_MEMORY + "! (STACK_SIZE=" + 1024e3 + ")");
...
var __emscripten_init_main_thread_js = tb => {
  ...
  __emscripten_thread_init(tb, /*is_main=*/ !ENVIRONMENT_IS_WORKER, /*is_runtime=*/ 1, /*can_block=*/ !ENVIRONMENT_IS_WEB, /*default_stacksize=*/ 1024e3, /*start_profiling=*/ false);
  PThread.threadInitTLS();
};
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_fcntl64, ___syscall_ioctl, ___syscall_openat, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write, _emscripten_set_window_title ];
...
var _imgui_clipboard_set_from_js = Module["_imgui_clipboard_set_from_js"] = createExportWrapper("imgui_clipboard_set_from_js", 1);
